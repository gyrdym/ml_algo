...
abstract class LinearClassifier implements Classifier {
  ...
  /// one-vs-all, and per each label one classifier is fitted. This approach is also called "ovr" (one versus rest)
  /// multiclass classification. The algorithm uses maximization of the passed data likelihood. In other words,
  /// the regressor iteratively tries to select coefficients, that makes combination of passed features and these
