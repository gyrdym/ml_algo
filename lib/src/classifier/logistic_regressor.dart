...
abstract class LogisticRegressor implements LinearClassifier, Assessable {
  ...
  /// two subsequent iterations. Uses as a condition of convergence in the
  ...
  ///
  /// [lambda] A coefficient of regularization. Uses to prevent the classifier
  /// from overfitting. The more the value of [lambda], the more regular the
  ...
  /// `false`. Intercept is a bias of the line (relative to X-axis) to be
  ...
  ///
  /// [initialCoefficientsType] Defines the coefficients for the first iteration
  /// of optimization. By default, all the coefficients equal zeroes at the
  /// start.
  ///
