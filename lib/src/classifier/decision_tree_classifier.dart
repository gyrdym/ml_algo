...
///
/// Process of obtaining such a recursive subsets structure is called
...
abstract class DecisionTreeClassifier implements Classifier, Assessable {
  ...
  /// labels
  ///
  /// [minError] A value from range 0..1 (both inclusive). The value is used as
  /// a stop criteria to avoid farther decision's tree node splitting: if the
