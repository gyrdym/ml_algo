...
abstract class CrossValidator {
  ...
  ///
  /// It splits a dataset into [numberOfFolds] test sets and subsequently evaluates the predictor on each produced test
  /// set
  ...
  ///
  /// It splits a dataset into all possible test sets of size [p] and subsequently evaluates quality of the predictor
