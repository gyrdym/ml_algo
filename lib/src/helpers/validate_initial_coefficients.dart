...
void validateInitialCoefficients(
    Vector coefficients, bool fitIntercept, int featuresNumber) {
  final expectedNumber = fitIntercept ? featuresNumber + 1 : featuresNumber;
