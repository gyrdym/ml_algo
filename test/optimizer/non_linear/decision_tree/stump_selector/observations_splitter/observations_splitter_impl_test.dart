import 'package:ml_algo/src/optimizer/non_linear/decision_tree/stump_selector/observations_splitter/observations_splitter_impl.dart';
...
void main() {
  group('NodeSplitterImpl', () {
    test('should split given matrix into two parts: first part should contain '
      ...
      final splitter = const ObservationsSplitterImpl();
