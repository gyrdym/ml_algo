...
void main() {
  group('NominalTreeSplitterImpl', () {
    ...
    test(
        'should perform split, splitting column contains only splitting '
        'value', () {
    ...
    test(
        'should perform split, splitting column contains different '
        'values', () {
      final samples = Matrix.fromList([
        [11, 22, 1, 30],
        [60, 23, 1, 20],
    ...
    test(
        'should return an empty list if no one value from the splitting value '
